// Single static-rendering declaration required for static export builds
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full overflow-hidden text-white">
        <header className="bg-[#7d2cff]/80 backdrop-blur-xl shadow-lg py-1.5 px-4 sm:px-6 flex-shrink-0 border-b border-white/20">
        ...
        <div className="flex-1 overflow-hidden px-3 sm:px-4 py-2 relative">
          <div className="grid grid-cols-12 grid-rows-12 gap-2 h-full min-h-0 overflow-hidden">
            <div className="col-span-3 row-span-3 flex flex-col gap-2 min-h-0">
            ...
            <div className="col-span-6 col-start-4 row-span-8 relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl overflow-hidden p-3 min-h-0">
            ...
            <div className="col-span-3 row-span-4 row-start-4 min-h-0">
              <PieChart data={pieChartData} title="Tickets by Status" />
            </div>
            <div className="col-span-3 row-span-4 row-start-8 min-h-0">
              <LineChart data={lineChartData} title="Daily Trend" />
            </div>

            <div className="col-span-12 row-span-2 row-start-11 bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg shadow-xl p-3 min-h-0">
